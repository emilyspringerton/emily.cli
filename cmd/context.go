...
func runContextBuild(args []string) int {
	...
	if apiKey == "" {
		fmt.Fprintln(os.Stderr, "emily context build: ANTHROPIC_API_KEY is not set")
		return 2
	}
	...
	b.WriteString("*Auto-generated by `emily context build`. Dense bilingual context for Emily Prime.*\n")
