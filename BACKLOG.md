...
- [x] **emily tui: F5 = fire RSI loop** — spawns rsi-loop.sh (MAX_ITERS=1 SKIP_WAIT=1) in goroutine, streams to RSI ACTIVITY LOG, RSI LOOP panel shows [F5] hint when idle, ACTIONS panel updated. Done 2026-06-12. Apple #388. Commit 8c49b66.
